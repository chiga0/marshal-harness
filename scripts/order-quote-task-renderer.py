#!/usr/bin/env python3
# order-quote 业务验收的 task/policy fixture 渲染器（历史 fixed-server-t2-task.py 的复制件，2026-09-11 随 Go 线退役改名保留）。
# 供给 order-quote-oracle_test.py / order-quote-team-oracle_test.py 生成可验收的 task.json/policy.json；与 Go canary 流程再无关联。
import argparse
import datetime
import hashlib
import json
