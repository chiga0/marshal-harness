...
import {syntheticInput,evaluate} from './review-assessment-component.ts';
import * as ports from '../packages/task-application/leader-ports.ts';
import * as contract from '../packages/task-application/review-assessment-contract.ts';
import * as adapter from '../packages/task-application/review-assessment.ts';
import * as normalization from '../packages/agent-observation/normalization.ts';
import {bindGenericFilesPlan} from '../packages/task-generic-files/layout.ts';
import {assessmentFixture,assessmentProposal} from '../packages/task-application/review-assessment.fixture.ts';
