...
| 用户授权的 Harness 本地闭环、单次 aggregate rework 的 finding→真实测试闭环、纵切交付、按风险去重的工程测试、公开 CLI JSON shape 兼容、Web、cleanup、SemVer/release、覆盖率、milestone 声明 | `engineering-and-release.md` |
