...
describe('设置返回路径闭集', () => {
  it.each(['/', '/?status=running', '/tasks/new', '/tasks/task-1', '/tasks/task-1/team?worker=w-1', '/tasks/task-1/graph', '/tasks/task-1/artifacts', '/tasks/task-1/activity'])('保留内部路径 %s', returnTo => {
