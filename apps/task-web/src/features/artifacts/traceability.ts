...
for (const key of ['Plan', 'PlanNode', 'PlanRepair', 'PlanInteraction', 'Limits', 'Edge', 'ObservationFrame', 'WorkerObservation', 'LastResponseUsage', 'ExecutionDiagnostic', 'LeaderProtocolCorrection', 'LeaderProtocolFailure']) {
