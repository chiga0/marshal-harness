...
import {parseAssessmentProposal, validateReviewAssessment} from './review-assessment-contract.ts';
...
export const reviewAssessmentSourceDigest = digest(encode([
  './review-assessment.ts', './review-assessment-contract.ts', './leader.ts', '../task-service/composition.ts',
