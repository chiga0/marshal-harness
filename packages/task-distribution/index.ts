...
export const SOURCE_FILES = Object.freeze([
  'packages/agent-acp/client.ts',
  'packages/agent-observation/normalization.ts',
  'packages/agent-pi-rpc/client.ts',
  'packages/agent-provider-acp/index.ts',
  'packages/agent-provider-pi/bridge-contract.ts',
  'packages/agent-provider-pi/index.ts',
  'packages/agent-provider-pi/native-bridge.ts',
  'packages/agent-provider-pi/shell-operations.ts',
  'packages/agent-runtime/custody-contract.ts',
  'packages/agent-runtime/custody-files.ts',
  'packages/agent-runtime/custody-process.ts',
  'packages/agent-runtime/custody.ts',
  'packages/agent-runtime/guard.ts',
  ...
  'packages/task-application/application.ts',
  'packages/task-application/artifacts.ts',
  'packages/task-application/clarification.ts',
  'packages/task-application/cleanup.ts',
  'packages/task-application/execution.ts',
  'packages/task-application/graph.ts',
  'packages/task-application/input-audit.ts',
  'packages/task-application/leader-ports.ts',
  'packages/task-application/leader-protocol-correction.ts',
  'packages/task-application/leader.ts',
  'packages/task-application/model.ts',
  'packages/task-application/observation.ts',
  'packages/task-application/repair.ts',
  'packages/task-application/review-assessment-contract.ts',
  'packages/task-application/review-assessment.ts',
  'packages/task-application/runtime-questions.ts',
  'packages/task-application/verification.ts',
  'packages/task-application/worker-cancellation.ts',
  'packages/task-artifacts/depot.ts',
  'packages/task-business/index.ts',
  'packages/task-client/index.ts',
  'packages/task-execution/controller.ts',
  'packages/task-files/index.ts',
  'packages/task-generic-files/checker.ts',
  'packages/task-generic-files/index.ts',
  'packages/task-generic-files/layout.ts',
  'packages/task-generic-files/permission.ts',
  'packages/task-generic-files/policy.ts',
  'packages/task-generic-files/qwen-file-tools.ts',
  'packages/task-generic-files/qwen-review-service-config.ts',
  'packages/task-generic-files/qwen-service-config.ts',
  'packages/task-generic-files/qwen-short-service-config.ts',
  'packages/task-generic-files/review-wire.ts',
  'packages/task-generic-files/service-config.ts',
  'packages/task-generic-files/short-wire.ts',
  'packages/task-git-business/git.ts',
  'packages/task-git-business/index.ts',
  'packages/task-leader-report/index.ts',
  'packages/task-leader-report/permission.ts',
  'packages/task-leader-report/policy.ts',
  'packages/task-leader-report/report-server.ts',
  'packages/task-leader-report/service-config.ts',
  'packages/task-local/discovery.ts',
  'packages/task-local/install-command.ts',
  'packages/task-local/main.ts',
  'packages/task-publication-report/command.ts',
  'packages/task-publication-report/index.ts',
  'packages/task-publication-report/io.ts',
  'packages/task-publication-report/runner.ts',
  'packages/task-regional-window/checker.ts',
  'packages/task-regional-window/consumer.ts',
  'packages/task-regional-window/driver.ts',
  'packages/task-regional-window/index.ts',
  'packages/task-regional-window/policy.ts',
  'packages/task-regional-window/service-config.ts',
  'packages/task-service/cli-shutdown.ts',
  'packages/task-service/composition.ts',
  'packages/task-service/launch.ts',
  'packages/task-service/main.ts',
  'packages/task-service/service-diagnostic.ts',
  'packages/task-store/runtime.ts',
  'packages/task-store/store.ts',
  'packages/task-supervisor/controller.ts',
  'packages/task-verification-command/index.ts',
]);
const ENTRYPOINT = 'packages/task-service/main.ts';
...
function runtimePath(file) {
  ...
  return !file.startsWith('packages/task-distribution/') && !file.includes('/fixtures/') &&
    !file.endsWith('/README.md') && !/\.(test|fixture)\.ts$/.test(file);
}
