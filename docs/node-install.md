...
> 本页命令默认针对 stable `v1.0.2`。使用带 UI 与默认通用文件团队的预发布版，请按[快速开始](getting-started.md)及[RC.2 发行记录](v1.1.0-rc.2-release-dossier-2026-09-14.md)选择版本；下文 stable 必需的业务配置不作为 RC.2 普通文件任务前置。
