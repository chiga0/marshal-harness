...
| 6：其余 Adapter 与 Recovery 加固 | `IN_PROGRESS` | [冻结范围](milestone-6-scope.md)；三 Adapter captured 模式与真实 Live E2E、Planning、Approval/Intervention、CI Deadline、Reconciliation、Cleanup Guard、cmux TerminalSession 基础、密封 launcher、Provider-neutral `TerminalLaunchSpec`、三 Adapter 原生 TUI 冻结规格、digest-bound `StartPrepared` 映射及 [Operator Runbook](operator-runbook.md) 已完成；真实受监督 cmux Pilot因本机 `workspace-rpc-unavailable` 安全阻断，完整 MVP E2E 尚待完成 |
