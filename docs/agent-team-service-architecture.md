...
批准前，业务要求与固定事实、范围、操作和恢复政策形成可读的验收约定；每项绑定原文、检查方式与不适用边界。独立 Reviewer 必须逐项提交判断、原材料引用、失败关联与必要的状态推演，Core 核对目录完整性、原输入与选果绑定，并将报告和逐项证据原子保存。引用真实不代表推理必然正确，仍以保留的正反业务案例、实际效果验证和独立验收检验判断能力。方案交付检查设计闭合；软件交付还须验证实际运行。具体闭合合同见 [ADR0106](adr/0106-bound-review-assessments.md)。
