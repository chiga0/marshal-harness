...
func TestSealedPiConfiguredRejectsOtherFrozenAdapters(t *testing.T) {
	...
	if sealedPiConfigured("pi", false, "/fixed/node", "/fixed/pi.js") || sealedPiConfigured("pi", true, "", "/fixed/pi.js") || sealedPiConfigured("pi", true, "/fixed/node", "") {
		t.Fatal("incomplete Pi configuration was admitted")
	}
}
