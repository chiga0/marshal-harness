...
2026-08-29 接受 ADR 0066，冻结 S2 的两阶段 owner acquisition、canonical repository `.marshal` 与 fixed `cmd/marshal` 本地 CLI production composition 边界；接受只冻结合同，不表示 S2 已实现或成熟度升级。
